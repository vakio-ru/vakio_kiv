...
Интеграция для Homeassiant, позволяющая управлять устройствами линейки Vakio Kiv.
...
- Управление заслонкой:
  1) В разделе "Действия" на экране "Новая автоматизация" нажмите кнопку **Добавить действие** -> **Устройство**;
  2) **Устройство**: Выберите устройство "\<Vakio Kiv\>", которым хотите управлять;
  3) **Действие**: Выберите "**Change \<Vakio Kiv\> option**"
  4) **option**: Выберите желаемую опцию.
